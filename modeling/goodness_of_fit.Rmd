...
ggplot(x) +
  ...
  coord_fixed()
ggsave("~/Downloads/true_mixture.svg", dpi = 400, width = 5)
```
...
ggsave("~/Downloads/modeling_iteration.svg", dpi = 500, width = 1.1 * 7, height = 1.1 * 4.5)
```
...
for (m in unique(p_df$model)) {
  p_df %>%
    ...
    coord_fixed() +
    labs(x = "dimension 1", y = "dimension 2")
  ggsave(glue::glue("~/Downloads/{m}.svg"), width = 5.5, height = 4.5)
  ...
  p_df %>%
    ...
    coord_fixed() +
    labs(x = "dimension 1", y = "dimension 2")
  ggsave(glue::glue("~/Downloads/{m}-prob.svg"), width = 5.5, height = 4.5)
  ...
  p_df %>%
    ...
    coord_fixed() +
    labs(x = "dimension 1", y = "dimension 2")
  ggsave(glue::glue("~/Downloads/true-{m}-prob.svg"), width = 5.5, height = 4.5)
}
```
