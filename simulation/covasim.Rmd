...
i = 0
for symp_prob in np.linspace(0, 1, 10):
  for trace_prob in np.linspace(0, 1, 10):
    for trace_time in np.linspace(0, 5, 5):
...
ggplot(results) +
  geom_point(aes(t, new_infections, col = symp_prob)) +
  scale_y_log10()
#ggplot(py$sim_res) +
